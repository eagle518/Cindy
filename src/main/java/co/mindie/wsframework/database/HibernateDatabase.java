...
import co.mindie.wsframework.database.tools.TracedHibernateDatabaseHandle;
import co.mindie.wsframework.exception.ConfigurationException;
import co.mindie.wsframework.utils.Pausable;

public class HibernateDatabase extends WSDatabase implements Pausable {
				...
				if (this.sessionFactory == null) {
					...
					if (this.jdbcConnectionString != null) {
						...
						if (this.jdbcConnectionString.startsWith("jdbc:mysql:")) {
							...
							configuration.getProperties().setProperty("hibernate.dialect", "co.mindie.wsframework.database.dialect.WSMySQLDialect");
							...
							configuration.getProperties().setProperty("hibernate.dialect", "co.mindie.wsframework.database.dialect.WSH2Dialect");
