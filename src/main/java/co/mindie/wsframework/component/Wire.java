...
public class Wire {
	...
	public void set(Object object, Object value) {
		try {
			...
			throw new WSFrameworkException("Unable to set wire " + this.field.getName() + " of type " + this.field.getType().getName() + " to " + object.getClass().getSimpleName(), e);
		}
	}
	...
	public Object get(Object object) {
		try {
			...
			throw new WSFrameworkException("Unable to get wire " + this.field.getName() + " of type " + this.field.getType().getName() + " to " + object.getClass().getSimpleName(), e);
		}
	}
