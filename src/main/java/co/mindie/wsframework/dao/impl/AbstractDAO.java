...
import co.mindie.wsframework.service.WSService;

public abstract class AbstractDAO<ElementType, PrimaryKey extends Serializable, DatabaseType> extends WSService {
