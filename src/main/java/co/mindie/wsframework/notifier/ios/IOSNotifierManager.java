...
import co.mindie.wsframework.notifier.NotifierListener;

public class IOSNotifierManager extends WSComponent implements Closeable {
	...
	public IOSNotifier addNotifier(String bundleId, boolean useProduction) {
		...
		if (notifier != null) {
			throw new WSFrameworkException("A notifier with the same bundleId and useProduction value has been already set");
		}
