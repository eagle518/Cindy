...
import co.mindie.wsframework.authorizer.IRequestContextAuthorizer;
...
import co.mindie.wsframework.component.ITempComponentContextHandler;
import co.mindie.wsframework.component.ITempComponentsContextHandler;
import co.mindie.wsframework.component.WSComponent;
import co.mindie.wsframework.configuration.WSConfiguration;
import co.mindie.wsframework.console.Log4jSocketConsole;
import co.mindie.wsframework.context.RequestContext;
import co.mindie.wsframework.controller.IParameterNameResolver;
import co.mindie.wsframework.controller.IRequestErrorHandler;
import co.mindie.wsframework.controller.SnakeCaseToCamelCaseParameterNameResolver;
import co.mindie.wsframework.controller.builtin.DefaultRequestErrorHandler;
import co.mindie.wsframework.controllermanager.ControllerManager;
import co.mindie.wsframework.database.handle.builtin.SimpleHibernateDatabaseHandle;
import co.mindie.wsframework.filehandling.IFileHandler;
import co.mindie.wsframework.misc.ComponentScanner;
import co.mindie.wsframework.modelconverter.ResolverManager;
...
import co.mindie.wsframework.utils.Pausable;

public class WSApplication extends WSComponent implements Closeable, Pausable {
	...
	public WSApplication(ComponentMetadataManager componentMetadataManager) {
		super();
