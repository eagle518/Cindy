...
public class CindyHibernateConfiguration extends org.hibernate.cfg.Configuration {
	...
	private void configureForMySQL() {
		...
		this.getProperties().setProperty("hibernate.dialect", "co.mindie.cindy.hibernate.dialect.CindyMySQLDialect");
	...
	private void configureForH2() {
		...
		this.getProperties().setProperty("hibernate.dialect", "co.mindie.cindy.hibernate.dialect.CindyH2Dialect");
